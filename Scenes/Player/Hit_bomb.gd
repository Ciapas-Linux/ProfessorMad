...
func _explode():
	...
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-105.0,105.0), player.global_position.y - randf_range(425.0,735.0)), 1.6)
	...
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,505.0), player.global_position.y - randf_range(385.0,605.0)), 1.7)
	...
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-475.0,575.0) , player.global_position.y - randf_range(385.0,605.0)), 1.8)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.5)
	
	body_parts = get_node("../../Body_parts/Hand_L/ForeArm_L")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.5)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-475.0,475.0), player.global_position.y - randf_range(385.0,605.0)), 1.5)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.6)
	
	body_parts = get_node("../../Body_parts/Leg_L")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.2)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-475.0,575.0), player.global_position.y - randf_range(385.0,605.0)), 1.4)
	...
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-475.0,575.0), player.global_position.y - randf_range(385.0,605.0)), 1.3)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.4)
	
	body_parts = get_node("../../Body_parts/Leg_L/Foot_L/Calf_L")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.5)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,555.0), player.global_position.y - randf_range(385.0,605.0)), 1.3)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.5)
	
	body_parts = get_node("../../Body_parts/Leg_R")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.2)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-495.0,595.0), player.global_position.y - randf_range(385.0,605.0)), 1.5)
	...
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,405.0), player.global_position.y - randf_range(285.0,435.0)), 1.3)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.4)
	
	body_parts = get_node("../../Body_parts/Leg_R/Foot_R/Calf_R")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.2)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,505.0), player.global_position.y - randf_range(285.0,535.0)), 1.3)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.3)
	
	body_parts = get_node("../../Body_parts/Body")
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.4)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,505.0), player.global_position.y - randf_range(425.0,635.0)), 1.2)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.6)
	...
	tween.tween_property(body_parts, "global_rotation", randf_range(-5.0,5.0), 1.9)
	tween.tween_property(body_parts, "global_position", Vector2(player.global_position.x + randf_range(-405.0,605.0), player.global_position.y - randf_range(325.0,635.0)), 1.1)
	tween.tween_property(body_parts, "self_modulate", Color(1, 1, 1, 0), 1.6)
